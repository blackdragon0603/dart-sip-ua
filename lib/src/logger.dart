...
class Log extends Logger {
  ...
  static Log init(String currentWorkingDirectory) {
    final Log log = Log._internal(currentWorkingDirectory);
    _self = log;
